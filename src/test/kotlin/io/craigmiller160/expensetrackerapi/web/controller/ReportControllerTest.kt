...
constructor(
  ...
  fun setup() {
    ...
    val txn1 =
      dataHelper.createTransaction(1L, cat1.recordId).let {
        transactionRepository.save(it.apply { expenseDate = month1.plusDays(1) })
      }
    val txn2 =
      dataHelper.createTransaction(1L, cat2.recordId).let {
    ...
    dataHelper.createTransaction(2L, cat3.recordId).let {
    ...
    val txn7 =
      dataHelper.createTransaction(1L, cat5.recordId).let {
        transactionRepository.save(it.apply { expenseDate = month1.plusDays(7) })
      }
    val txn8 =
      dataHelper.createTransaction(1L, cat4.recordId).let {
